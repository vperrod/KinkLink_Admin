...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | kinklink - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for kinklink - React.js Tailwind CSS Admin Dashboard Template"
      />
